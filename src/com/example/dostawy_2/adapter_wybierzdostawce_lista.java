...
public class adapter_wybierzdostawce_lista extends ArrayAdapter<Dostawca>{
	
	private Context mContext;
	private List<Dostawca> mListDostawcy;
	
	
	public adapter_wybierzdostawce_lista(Activity context, List<Dostawca> ListDostawcy) {
